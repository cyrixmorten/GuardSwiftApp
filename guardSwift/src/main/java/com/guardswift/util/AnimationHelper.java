...
public class AnimationHelper {
    ...
    public static void showhide(View view) {
        showhide((view.getVisibility() == View.GONE),view,null);
    }

    public static void showhide(boolean show, View view, Animation.AnimationListener animationListener) {
        if (show) {
