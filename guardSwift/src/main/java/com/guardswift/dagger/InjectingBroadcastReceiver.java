 ...
 */
public class InjectingBroadcastReceiver extends BroadcastReceiver implements
		Injector {
	...
	/**
	 * Creates an object graph for this BroadcastReceiver by extending the
	...
	public void onReceive(Context context, Intent intent) {
		...
		// broadcast receiver
		mObjectGraph = ((Injector) context.getApplicationContext())
	 ...
	 * BroadcastReceiver's object graph. Subclasses that override this method
	...
	public static class InjectingBroadcastReceiverModule {
		 ...
		 * 
		 * @param receiver
		 *            the InjectingBroadcastReceiver with which this module is
		 *            associated.
		 */
		public InjectingBroadcastReceiverModule(Context context,
				android.content.BroadcastReceiver receiver, Injector injector) {
			mContext = context;
			mReceiver = receiver;
			mInjector = injector;
		}
		...
		/**
		 * Provides the Context for the BroadcastReceiver associated with this
		 * graph.
		 * 
