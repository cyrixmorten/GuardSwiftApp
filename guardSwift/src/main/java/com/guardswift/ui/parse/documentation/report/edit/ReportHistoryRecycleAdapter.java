 ...
 */
public class ReportHistoryRecycleAdapter extends ParseRecyclerQueryAdapter<EventLog, ReportHistoryRecycleAdapter.ReportViewHolder> {


    private static final String TAG = ReportHistoryRecycleAdapter.class.getSimpleName();
    ...
    public ReportHistoryRecycleAdapter(Context context, GSTask task, CoordinatorLayout snackBar, ParseQueryAdapter.QueryFactory<EventLog> queryFactory) {
        super(queryFactory);
