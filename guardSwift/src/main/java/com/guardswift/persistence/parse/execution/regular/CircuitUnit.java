...
public class CircuitUnit extends BaseTask implements  MessagesHolder {
...
//            return true;
    ...
    public static final String PIN = "CircuitUnit";
...
//            query.include(messages);
            ...
            query.include(client + "." + Client.messages);
