...
//
//
//        public static void setSelected(ParseModulePreferences preferences, Circuit circuit) {
//
//            selected = circuit;
//
//            if (preferences == null)
...
//    }
	...
	public static final String PIN = "Circuit";
...
//	public static final String timeEnd = "timeEnd";
	...
	public static class QueryBuilder extends ParseQueryBuilder<Circuit> {
		...
		public QueryBuilder(boolean fromLocalDatastore) {
			super(PIN, fromLocalDatastore, ParseQuery.getQuery(Circuit.class));
		}
