...
//
//import static com.guardswift.persistence.parse.execution.task.regular.CircuitStarted.circuit;
//
//
...
//        return getParseGeoPoint(CircuitUnit.position);
//    }
//
//
//    public CircuitStarted getCircuitStarted() {
//        Circuit circuit = getCircuit();
//        CircuitStarted cachedCircuitStarted = GuardSwiftApplication.getInstance().getCacheFactory().getTaskGroupStartedCache().matching(circuit);
...
//            GuardSwiftApplication.getInstance().getCacheFactory().getTaskGroupStartedCache().addActive(ldsCircuitStarted);
...
//            }
//
//            Log.d(TAG, "matching taskGroup: " + circuit.getObjectId());
//
...
//        put(CircuitUnit.geofenceRadius, radius);
//    }
//
//    @Override
//    public int getRadius() {
//        if (has(CircuitUnit.geofenceRadius) && getInt(CircuitUnit.geofenceRadius) > 0) {
//            return getInt(CircuitUnit.geofenceRadius);
//        }
//
//        if (isRaid()) {
//            return ParseTask.DEFAULT_RADIUS_RAID;
//        }
//        return ParseTask.DEFAULT_RADIUS_REGULAR;
//    }
//
//    @Override
